...
public class FragmentAwaitingApprovalMvvm extends AndroidViewModel {

    private MutableLiveData<Boolean> isDataLoading;
    private MutableLiveData<List<OrderModel>> onDataSuccess;
    private CompositeDisposable disposable = new CompositeDisposable();

    public FragmentAwaitingApprovalMvvm(@NonNull Application application) {
        super(application);
    }
...
//    public void changeStatusOrder(String order_id){
//
//    }
